...
Copy-Item build\app\outputs\flutter-apk\app-release.apk "releases\Aprender IA 2.2 Beta ARM64.apk" -Force
Write-Host 'APK lista: releases\Aprender IA 2.2 Beta ARM64.apk'
