...
final class ThoughtLibraryReader {
  ...
  Future<ThoughtLibrary> load() async {
    ...
    final extra2 = parse(
      await rootBundle.loadString('knowledge/thought_library_expansion_v2.json'),
    );
    return ThoughtLibrary(
      topics: <String>{...base.topics, ...extra.topics, ...extra2.topics}.toList(),
      authors: <String>{...base.authors, ...extra.authors, ...extra2.authors}.toList(),
      ideas: <ThoughtIdea>[...base.ideas, ...extra.ideas, ...extra2.ideas],
    );
  }
