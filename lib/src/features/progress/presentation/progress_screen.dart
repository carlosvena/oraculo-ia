            ...
            child: Column(
              children: <Widget>[
                ListTile(
                  ...
                  title: const Text('Acerca de esta versión'),
                  subtitle: const Text('Qué versión de la app tenés instalada'),
                ...
                ListTile(
                  ...
                  title: const Text('Respaldo y reinicio'),
                  subtitle: const Text('Guardar tu progreso o volver al principio'),
                  trailing: const Icon(Icons.chevron_right),
