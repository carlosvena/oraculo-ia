...
final class LearningStateNotifier extends AsyncNotifier<LearningState> {
  ...
  /// Guarda el nombre y trabajo reales de quien está usando la app en este
  /// dispositivo, para que los ejemplos del mentor hablen de su trabajo,
  /// no de uno fijo en el código.
  ...
  /// Vuelve al principio: borra todo el progreso guardado (misiones,
  /// XP, favoritos, historial) y deja la app como recién instalada.
  Future<void> reset() => _set(const LearningState());
}
